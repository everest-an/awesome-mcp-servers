...
- **[Awareness](https://github.com/everest-an/Awareness-Market)** - Local-first persistent memory for coding agents. 96.0% Recall@5 on LongMemEval (ICLR 2025) with zero LLM calls at retrieval; runs offline, no account needed.
